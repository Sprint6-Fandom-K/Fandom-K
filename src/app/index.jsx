...
export class Modal
{
	/** @type {?Modal} */ static instance; static core = new EventTarget();

	element; timeout; onClickOutSide;
	...
	shake()
	{
		if (Modal.instance === this)
		{
			...
			this.timeout = setTimeout(() => document.getElementById("modal").classList.remove("shake"), 750);
		}
	}
