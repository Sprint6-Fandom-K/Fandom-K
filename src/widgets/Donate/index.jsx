				...
				<div className="milestone">
					<div className="wrapper">
						...
						<div className="deadline skeleton">
							{props.donation ? countdown(time, new Date(Date.parse(props.donation.deadline)), LOCALE) + "\u0020" + "남음" : "..."}
						</div>
					</div>
					<div className="progress" style={{ backgroundImage: `linear-gradient(to right, #F96D69 ${props.donation ? (props.donation.receivedDonations / props.donation.targetDonation) * 100 : 0}%, #FFFFFF ${props.donation ? (props.donation.receivedDonations / props.donation.targetDonation) * 100 : 0}%)` }}></div>
				</div>
			</div>
		</section>
	);
